...
// Component to display the upcoming TV shows page
const UpcomingTVPage: React.FC = () => {
  const { language } = useLanguage(); // Get the current language from context
  const [page, setPage] = useState(1); // State to manage the current page

  // Function to fetch upcoming TV shows based on the current page and language
  ...
  // Query to fetch upcoming TV shows using react-query
